...
import {
    ...
    deactivateBanners,
    getBannersActive
} from '../../redux/actions/icon-banners/indexActiveActions';
import {
    activateBanner,
    activateBanners,
    deleteBanner,
    deleteBanners,
    getBannersInactive
} from '../../redux/actions/icon-banners/indexInactiveActions';
...
// State
const mapStateToProps = ({ iconBanners: { indexActive, indexInactive } }) => ({
...
const IconBannersIndex = ({
    ...
    const getActiveTableActions = ({ id, name }) => ([
        ['Edit', () => history.push(`/icon_banners/${id}`), <EditIcon />],
    ...
    const handleCreateRedirect = () => history.push('/icon_banners/create');
    ...
    return (
        <React.Fragment>
            ...
            <Tabs
                ...
                actions={[['Add New Icon Banner', handleCreateRedirect, <CreateIcon />]]}
            >
...
IconBannersIndex.defaultProps = defaultProps;
IconBannersIndex.propTypes = propTypes;

export default connect(mapStateToProps, mapDispatchToProps)(withRouter(IconBannersIndex));
